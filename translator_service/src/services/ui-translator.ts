...
import { ReactComponentSpec, ComponentMapping } from '../types/react-components';

// Define CSSProperties type for server-side use
...
export class UITranslator {
   ...
   */
  private translateNode(node: UIASTNode): ReactComponentSpec {
    ...
    const reactSpec: ReactComponentSpec = {
   ...
   */
  private translateProps(flutterProps: Record<string, any>, mapping: ComponentMapping): Record<string, any> {
    const reactProps: Record<string, any> = { ...mapping.defaultProps };
   ...
   */
  private translateStyle(flutterStyle: Record<string, any> | undefined, mapping: ComponentMapping): CSSProperties | undefined {
    if (!flutterStyle || !mapping.styleMapping) return flutterStyle as CSSProperties;

    const reactStyle: Record<string, any> = {};
